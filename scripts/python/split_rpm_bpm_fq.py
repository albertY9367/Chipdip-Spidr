...
def main():
    ...
    rpm_out_path = os.path.splitext(os.path.splitext(read_1_path)[0])[0] + '_rpm_spidr.fastq.gz'
    bpm_out_path =  os.path.splitext(os.path.splitext(read_1_path)[0])[0] + '_bpm_spidr.fastq.gz'
    short_out_path =  os.path.splitext(os.path.splitext(read_1_path)[0])[0] + '_short_spidr.fastq.gz'
