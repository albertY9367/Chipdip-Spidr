...
def main():
    ...
    dpm_out_path = base_path + "_dpm_chip.fastq.gz"
    # Correctly formated BPM reads
    bpm_out_path = base_path + "_bpm_chip.fastq.gz"
    # Reads with barcode in incorrect order
    other_out_path = base_path + "_other_chip.fastq.gz"
    # Reads with NOT_FOUND barcode
    short_out_path = base_path + "_short_chip.fastq.gz"
